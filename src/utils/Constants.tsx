...
export const TOUContent = "سایت Stu-Assist به صورت شخصی و غیر رسمی با هدف ارائه خدمات به دانشجویان مهاجر به کشور آلمان طراحی و توسعه داده شده است. در حال حاضر کاربران میتوانند پس از شارژ حساب کاربری خود، نمرات GPA و همچنین ECTS خود را بر مبنای کشور آلمان محاسبه و مشاهده نمایند. همچنین برنامه نویسان داوطلب میتوانند جهت توسعه قابلیت های فنی وبسایت، درخواست همکاری خود را به ایمیل مدیریت ارسال نمایند. "
